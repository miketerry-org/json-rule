...
class DateRule extends PropertyRule {
  ...
  check(data) {
    ...
    // if minDate Ruleified then verify value is greater than or equal to it
    if (this.min && value < this.min) {
      this.tooSmall(value);
    }

    // if max date is Ruleified then ensure value is less than or equal to it
